...
//        props.put(ErrorHandlingDeserializer.VALUE_FUNCTION, FailedCatProvider.class);
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, SpecificRecord> jsonListenerContainerFactory(
            KafkaTemplate<Object, Object> commonKafkaTemplate) {
...
//        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, JsonPayload.class.getCanonicalName());
